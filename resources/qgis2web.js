...
map.getView().fit([387396.747077, 7809689.003242, 535188.321546, 7910530.564301], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Townsville Market Map</h2>';
        return titleElement;
    })(),
